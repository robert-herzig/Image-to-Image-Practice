...
class Main:
    def __init__(self):
        ...
        self.learning_controller = learning_controller.LearningController(use_Jung=True)
...
if __name__ == '__main__':
    ...
    main_controller.test("datasets/NYU2", 10001, False, "checkpoint/Test1/netG_model.pth", "checkpoint/Test1/netD_model.pth")
    #main_controller.train_only_global_generator("datasets/NYU2", 8001, False, "checkpoint/Test1/netG_model.pth", "checkpoint/Test1/netD_model.pth")
